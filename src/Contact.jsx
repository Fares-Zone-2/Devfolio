export default (Contact) => {
  return (
    <section id="contact" className="about-bg p-4 min-sm:p-10">
      <div className="text-center">
        <h1 className="text-4xl font-bold main-c mb-4">Get In Touch</h1>
        <p className="text-c text-[11px] m-auto">
          I'm always open to discussing new projects, creative ideas, or
          opportunities to be part of your visions.
        </p>
      </div>
      <div className="container">
        <div className="bg-white max-md:p-3 p-10 rounded-2xl shadow-2xl w-fit m-auto mt-30">
